...
/*
	...
	Enter subsection namesss

Enter chapter nameDSA

Enter number of sections in DSA2

Enter section namettt

Enter number of sub section2

Enter subsection namekkk

Enter subsection namelll

Enter section nameeee

Enter number of sub section1

Enter subsection nameqqq
-------------ABC---------------
	 =>BCD
		:nnn
			-mmm
